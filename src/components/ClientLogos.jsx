      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center mb-6">
            ...
            <span className="mx-4 text-sm font-semibold text-amber-600 uppercase tracking-wider">
              Our Partners
            </span>
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We partner with forward-thinking organizations to deliver
            exceptional results and drive meaningful business growth.
          </p>
        </div>
          ...
          <div className="overflow-hidden">
            ...
            >
              {duplicatedClients.map((client, index) => (
                ...
                >
                  {/* Card Container */}
                  <div className="relative bg-white rounded-xl border border-gray-100 p-8 h-32 flex items-center justify-center transition-all duration-300 hover:border-amber-200 hover:shadow-lg hover:-translate-y-1">
                    {/* Hover Accent */}
        ...
        >
          <p className="text-gray-600 mb-6">
            Ready to join our growing family of successful partners?
          </p>
          <Link
            to="/about#contact"
            onClick={() => {
              // delay to allow navigation before trying scroll
              setTimeout(() => {
                document
            ...
            className="inline-flex items-center px-8 py-3 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-amber-200 group"
          >
