      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="flex-[2] grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <a href="/people/team" className="block hover:underline">
                Team
              </a>
              <a href="/people/careers" className="block hover:underline">
                Careers
              </a>
            </div>
            <div>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10">
          ...
          <div>
            ...
            <p className="mt-2">
              92/64, Patel Marg, Sector 9,
              <br />
              Mansarovar, Jaipur
            </p>
            <div className="mt-2 space-x-4">
              <a
                href="https://www.linkedin.com/company/14409093/admin/page-posts/published/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/teamarchpoint/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline"
              >
              ...
              <a
                href="https://www.instagram.com/archpoint_architecture/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline"
              >
          ...
          <div>
            ...
            <a href="tel:9982507555" className="block mt-1 hover:underline">
              9982507555
            </a>
            <h5 className="mt-4 text-lg font-medium">Email</h5>
            <a
              href="mailto:contactarchpoint@gmail.com"
              className="hover:underline"
            >
              contactarchpoint@gmail.com
            </a>
          </div>
