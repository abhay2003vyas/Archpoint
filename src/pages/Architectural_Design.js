          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <div className="relative z-10 text-center px-4">
                <h2 className="text-sm tracking-widest text-white uppercase font-semibold mb-4">
                  Architecture & Design
                </h2>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {activeSection === "projects" && (
              <div>
                ...
                {/* Project Statistics */}
                <div className="mt-12 bg-gradient-to-r from-amber-500 to-yellow-500 text-white p-8 rounded-2xl text-center">
